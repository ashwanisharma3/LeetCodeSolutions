...
// Solution
// We eliminate 1 person by asking any two persons,
// and then, eliminate one by asking one more and
// the one from above result. Hence at the end n - 1
// persons would have been eliminated. Now we check
// with other peson if they know him or not.
